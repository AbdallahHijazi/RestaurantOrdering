...
export const MOCK_PUBLIC_MENU: PublicMenuPageData = {
  ...
  items: [
    ...
    },
    {
      ...
      descriptionAr: 'أرز كarnaroli مع فطر برّي وجبن parmesano.',
    ...
    },
    {
      ...
      nameAr: 'تشيز كيك البستachio',
      nameEn: 'Pistachio Cheesecake',
      descriptionAr: 'تشيز كيك كريمي مع فستق حلبي.',
    ...
    },
    {
      ...
      descriptionAr: 'شوكولاتة داكنة مع قشر البرتقال المُمَ caramelize.',
