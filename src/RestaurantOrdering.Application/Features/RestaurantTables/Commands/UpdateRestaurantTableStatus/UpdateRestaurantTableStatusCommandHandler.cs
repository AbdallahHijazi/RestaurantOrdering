...
public sealed class UpdateRestaurantTableStatusCommandHandler
    : IRequestHandler<UpdateRestaurantTableStatusCommand, RestaurantTableDto>
{
    private readonly IApplicationDbContext _context;
    private readonly IDateTimeService _dateTimeService;

    public UpdateRestaurantTableStatusCommandHandler(
    ...
    public async Task<RestaurantTableDto> Handle(
        UpdateRestaurantTableStatusCommand request,
